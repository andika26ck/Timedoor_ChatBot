---
judul: Known Risks & Undocumented Behaviors
kategori: FAQ
domain: Known Risks
label: [risiko, presensi, meeting-journal, send-key, unlock-lesson, cancel-jadwal, approval, troubleshooting]
dokumen_terkait: [sysrules_01_system-rules.md, teacher_07_create-meeting-journal.md, teacher_05_attendance.md]
sumber_asli: Notion — Academy LMS Knowledge Base > Known Risks & Undocumented Behaviors
