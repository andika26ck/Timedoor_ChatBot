---
judul: Chapter 5 - Accounting Management (Contract, Invoice, Paylater, Discount, Approval)
kategori: SOP
domain: CMS Admin
label: [upcoming contract, renew, combine invoice, paylater, discount, referral, sibling, approve attendance, approve report]
sumber_asli: Figma - [ID] Branch Admin_System Guidelines, slide 183-226
